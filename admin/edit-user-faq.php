<?php
$active_tab = 'user faqs';
require_once('templates/header.php');
require_once('templates/sidebar.php');
if(isset($_POST['submit']) && !empty($_POST['answer'])) {
  $where = 'question ="'.trim(strip_tags($_REQUEST['question'])).'" and fid!='.$_REQUEST['id'];
  ...
  if(!empty($data)) {
    ...
    if($QueryFire->upDateTable('faq',' fid='.$_REQUEST['id'],$arr)) {
...
$data = $QueryFire->getAllData('faq',' fid='.$_REQUEST['id'])[0];
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-xs-12">
                  <div class="form-group">
                    ...
                    <textarea name="question" class="form-control" rows="3" placeholder="Enter question"><?= $data['question']?></textarea>
                  </div>
                </div>                
                <div class="col-sm-12 col-md-12 col-xs-12">
                  <div class="form-group">
                    <label for="">Answer</label>
                    <textarea name="answer"  placeholder="Enter answer" rows="6" class="form-control summernote"><?= html_entity_decode($data['answer'])?></textarea>
                  </div>
                </div>
              </div>
            </div>
