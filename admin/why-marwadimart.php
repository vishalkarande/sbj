...
if(isset($_POST['submit']) && !empty($_POST['text'])) {
  ...
  if($QueryFire->upDateTable('pageandcontents',' id=2',$arr)) {
    $msg = 'Record updated successfully.';
  } else {
    $msg = 'Unable to update record.';
  }
}
$data = $QueryFire->getAllData('pageandcontents','id=2')[0];
?>
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Why Marwadi Mart</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="dashboard">Home</a></li>
            <li class="breadcrumb-item active">Why Marwadi Mart</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
