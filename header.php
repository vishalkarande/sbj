                ...
                <div class="whb-column whb-col-center whb-visible-lg">
                  ...
                  >
                    ...
                    >
                      <li
                        id="menu-item-1380"
                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-229 current_page_item menu-item-1380 item-level-0 menu-simple-dropdown wd-event-hover"
                      >
                      ...
                      >
                        <a href="products.php" class="woodmart-nav-link"
                    ...
                    >
                      <span class="wd-tools-icon wd-icon-alt">
                        <span class="wd-cart-number wd-tools-count"
                          ><?=$cart_value?><span>items</span></span
                        >
                      </span>
