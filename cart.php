...
?>
														...
														<tr class="woocommerce-cart-form__cart-item cart_item">
															...
															<td class="product-remove">
																<a href="?remove=<?php echo $product_id; ?>" class="remove" aria-label="Remove this item"
												...
												<div class="row cart-actions">
													...
													<div class="col-12 order-first order-md-last col-md-auto">
														...
														<button type="submit" class="button" name="update_cart_1"
															value="Update cart">Update cart</button>

                                                            <button type="submit" class="button empty-cart" name="empty_cart"
															>Empty Cart</button>
														
														<input type="hidden" id="woocommerce-cart-nonce"
															name="woocommerce-cart-nonce" value="6da0c40aaa" /><input
